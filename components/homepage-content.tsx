    ...
    <>
      ...
      <section className="relative pt-32 sm:pt-44 pb-20 sm:pb-28 px-5 overflow-hidden min-h-[85vh] flex flex-col justify-center">
        ...
        <div className="relative z-10 max-w-3xl mx-auto text-center">
          ...
          <p className="text-neutral-500 text-base sm:text-lg max-w-2xl mx-auto mt-6 leading-relaxed">
            Discover, book, and pay creators in one place — whether you are a
            brand team or an AI agent acting on behalf of one.
          </p>

          <div className="flex flex-col sm:flex-row gap-3 justify-center mt-10">
            <a
              href="/browse"
              className="inline-flex items-center justify-center bg-blue-500 hover:bg-blue-600 text-white rounded-lg px-8 py-3.5 font-semibold shadow-lg shadow-blue-500/25 hover:shadow-xl hover:shadow-blue-500/30 transition-all min-h-[48px] text-sm"
              style={{ fontFamily: "var(--font-display)" }}
            >
              Hire Creators
            </a>
            <a
              href="/for-agents"
              className="inline-flex items-center justify-center bg-white border border-neutral-200 text-neutral-700 rounded-lg px-8 py-3.5 font-medium hover:bg-neutral-50 hover:border-neutral-300 transition-all min-h-[48px] text-sm"
              style={{ fontFamily: "var(--font-display)" }}
            >
              Explore API
            </a>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="bg-white border border-neutral-100 rounded-2xl p-8 sm:p-10">
              ...
              <ul className="space-y-4">
                {[
                  {
                    title: "AI-matched creator discovery",
                    desc: "Find the right creators by niche, audience, and engagement metrics.",
                  },
                  {
                    title: "Direct booking and payments",
                    desc: "Send briefs, negotiate, and pay — all in one place.",
                  },
                  {
                    title: "Escrow-protected deals",
                    desc: "Funds are held securely and released only on delivery approval.",
                  },
                  {
                    title: "Campaign management",
                    desc: "Track briefs, deliverables, and payments from a single dashboard.",
                  },
                ].map((item) => (
                ...
                {[
                  {
                    ...
                    desc: "Full programmatic access to the creator marketplace.",
                  },
                  {
                    title: "Programmatic creator search and booking",
                    desc: "Search, filter, and book creators with API calls.",
                  },
                  {
                    title: "Domain-verified agent workflows",
                    desc: "Secure agent authentication tied to your organization.",
                  },
                  {
                    title: "Webhooks for autonomous hiring",
                    desc: "Real-time event notifications for end-to-end automation.",
                  },
                ].map((item) => (
                  <li key={item.title} className="flex gap-3">
                    <svg
      ...
      <section className="my-4">
        <div className="bg-blue-50 py-16 sm:py-24 rounded-3xl mx-4 sm:mx-6">
          <div className="max-w-5xl mx-auto px-5">
            <h2
              className="text-2xl sm:text-3xl text-neutral-900 text-center mb-12"
              style={{ fontFamily: "var(--font-display)" }}
            >
              How it works
            </h2>
              ...
              {[
                {
                  step: "1",
                  title: "Discover",
                  desc: "Browse creators or search via API. AI-scored profiles with engagement metrics, audience data, and niche classification.",
                },
                {
                  step: "2",
                  title: "Book",
                  desc: "Send a brief, negotiate, and book directly. Or let your AI agent handle the entire workflow programmatically.",
                },
                {
                  step: "3",
                  title: "Pay",
                  desc: "Escrow-protected payments. Creators keep 100%. Funds are released on delivery approval.",
                },
              ].map((item) => (
                <div
                  key={item.step}
                  className="aos-stagger-item bg-white rounded-2xl p-6 sm:p-8 shadow-md shadow-neutral-900/5"
                >
                  <div className="w-10 h-10 rounded-full bg-blue-500 text-white font-bold flex items-center justify-center text-sm">
                    {item.step}
                  </div>
                  <h3 className="font-semibold text-neutral-900 text-lg mt-4">
                    {item.title}
                  </h3>
      ...
      <section className="py-16 sm:py-24 px-5">
        <div className="max-w-3xl mx-auto text-center">
          <h2
            className="text-2xl sm:text-3xl text-neutral-900 mb-6"
            style={{ fontFamily: "var(--font-display)" }}
          >
            Creators keep everything.
          </h2>
          <p className="text-neutral-500 text-sm sm:text-base max-w-xl mx-auto mb-12">
            No platform fees. No hidden costs. You keep 100% of what brands pay
            you.
          </p>
      ...
      <section className="my-4 mb-8">
        <div className="bg-neutral-900 rounded-3xl mx-4 sm:mx-6 py-16 sm:py-20 px-5 text-white text-center">
          ...
          <p className="text-neutral-400 text-sm sm:text-base mt-4 max-w-lg mx-auto">
            Whether you are a brand, an agency, or building the next AI agent —
            HireACreator is the infrastructure layer.
          </p>
          <div className="flex flex-col sm:flex-row gap-3 justify-center mt-10">
            <a
              href="/claim"
            ...
            <a
              href="/for-agents"
              className="inline-flex items-center justify-center border border-white/20 text-white rounded-lg px-8 py-3.5 font-medium hover:bg-white/10 transition-all min-h-[48px] text-sm"
              style={{ fontFamily: "var(--font-display)" }}
            >
              Read API Docs
            </a>
