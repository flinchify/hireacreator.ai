  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        ...
        {/* Gradient presets */}
        <div className="grid grid-cols-3 md:grid-cols-4 gap-1.5 mb-3">
          {gradients.map(g => (
  ...
  return (
    <div className="min-h-screen bg-[#f8f8fa]">
      ...
      <div className="flex flex-col md:flex-row pt-14 min-h-screen">
        {/* ═══ LEFT SIDEBAR — Controls (full-width on mobile, fixed sidebar on desktop) ═══ */}
        <div className="w-full md:w-80 shrink-0 bg-white md:border-r border-neutral-200 overflow-y-auto pb-20 md:pb-0 md:sticky md:top-[56px] md:max-h-[calc(100vh-56px)]">
          <div className="p-4 md:p-5">
            {/* Panel selector tabs — horizontal pills */}
      ...
      {/* ═══ MOBILE BOTTOM BAR — Preview button (visible only on mobile) ═══ */}
