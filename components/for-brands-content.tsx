...
function ShieldIcon() {
  return (
    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" className="text-neutral-700 shrink-0">
...
export function ForBrandsContent() {
  ...
  "input": {
    ...
    "min_rating": 4.5
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <StaggerChildren className="space-y-4" staggerMs={100}>
              {[
                ...
                <div key={item.title} className="aos-stagger-item flex items-start gap-4 p-4 rounded-xl hover:bg-neutral-50 transition-colors">
                  <div className="mt-0.5 shrink-0 w-8 h-8 rounded-lg bg-neutral-900 flex items-center justify-center">
      ...
      {/* ─── Trust & Security ─── */}
      <AnimateOnScroll as="section" className="bg-neutral-50">
      ...
      <AnimateOnScroll as="section" className="bg-white">
        <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-24 sm:py-28 border-t border-neutral-100">
          ...
          {formStatus === "sent" ? (
            <div className="text-center py-12 border border-neutral-200 rounded-2xl">
