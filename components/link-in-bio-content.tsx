      ...
      <div className="min-h-screen flex flex-col sm:flex-row">
        ...
        <div className="sm:w-[55%] sm:overflow-y-auto sm:h-screen">
          <div className="px-6 sm:px-8 lg:px-10 py-6 sm:py-10">
            ...
            {creator.socials.length > 0 && <div className="flex flex-wrap gap-2 mb-6">{creator.socials.map(s => <a key={s.platform} href={s.url || "#"} target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 px-3 py-2 bg-neutral-50 border border-neutral-200 rounded-full hover:bg-neutral-100 transition-all"><PlatformIcon platform={s.platform} size={14} className="text-neutral-500" /><span className="text-xs text-neutral-600 font-medium">{s.handle || s.platform}</span></a>)}</div>}
