...
export type Creator = {
  ...
  linkBioFontSize: string;
  linkBioFontWeight: number;
  linkBioLetterSpacing: string;
  linkBioPagePadding: number;
  linkBioSectionGap: number;
  linkBioContainerWidth: string;
  linkBioAvatarShape: string;
  linkBioAvatarBorderWidth: number;
  linkBioAvatarBorderColor: string;
  linkBioAvatarShadow: string;
  linkBioAvatarMode: string;
  linkBioButtonFill: string;
  linkBioButtonTextColor: string;
  linkBioButtonBorder: boolean;
  linkBioButtonBorderWidth: number;
  linkBioButtonBorderColor: string;
  linkBioButtonShadow: string;
  linkBioButtonWidth: string;
  linkBioGradientDirection: string;
  linkBioGradientColor1: string;
  linkBioGradientColor2: string;
  linkBioBgOverlay: string;
  linkBioBgOverlayOpacity: number;
  linkBioGlassEnabled: boolean;
  linkBioGlassIntensity: number;
