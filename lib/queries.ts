...
function assembleCreator(
  ...
  return {
    ...
    linkBioFontSize: (user.link_bio_font_size as string) || "medium",
    linkBioFontWeight: (user.link_bio_font_weight as number) || 400,
    linkBioLetterSpacing: (user.link_bio_letter_spacing as string) || "normal",
    linkBioPagePadding: (user.link_bio_page_padding as number) ?? 16,
    linkBioSectionGap: (user.link_bio_section_gap as number) ?? 16,
    linkBioContainerWidth: (user.link_bio_container_width as string) || "standard",
    linkBioAvatarShape: (user.link_bio_avatar_shape as string) || "circle",
    linkBioAvatarBorderWidth: (user.link_bio_avatar_border_width as number) ?? 0,
    linkBioAvatarBorderColor: (user.link_bio_avatar_border_color as string) || "",
    linkBioAvatarShadow: (user.link_bio_avatar_shadow as string) || "none",
    linkBioAvatarMode: (user.link_bio_avatar_mode as string) || "photo",
    linkBioButtonFill: (user.link_bio_button_fill as string) || "",
    linkBioButtonTextColor: (user.link_bio_button_text_color as string) || "",
    linkBioButtonBorder: (user.link_bio_button_border as boolean) || false,
    linkBioButtonBorderWidth: (user.link_bio_button_border_width as number) ?? 1,
    linkBioButtonBorderColor: (user.link_bio_button_border_color as string) || "",
    linkBioButtonShadow: (user.link_bio_button_shadow as string) || "none",
    linkBioButtonWidth: (user.link_bio_button_width as string) || "standard",
    linkBioGradientDirection: (user.link_bio_gradient_direction as string) || "135deg",
    linkBioGradientColor1: (user.link_bio_gradient_color1 as string) || "",
    linkBioGradientColor2: (user.link_bio_gradient_color2 as string) || "",
    linkBioBgOverlay: (user.link_bio_bg_overlay as string) || "dark",
    linkBioBgOverlayOpacity: (user.link_bio_bg_overlay_opacity as number) ?? 40,
    linkBioGlassEnabled: (user.link_bio_glass_enabled as boolean) || false,
    linkBioGlassIntensity: (user.link_bio_glass_intensity as number) ?? 8,
