                    ...
                    <div className="flex items-center gap-3 mb-3">
                      ...
                      <div>
                        <div className="text-sm font-semibold text-indigo-900">
                          AI-designed page ready
                        </div>
                        <div className="text-xs text-indigo-600">
                          Customized based on your niche and content style
                        </div>
                      </div>
                    </div>
                    <div className="flex flex-wrap gap-2">
                      <span className="inline-flex items-center gap-1.5 text-xs font-medium bg-white/80 text-indigo-700 px-2.5 py-1 rounded-lg">
                        Template: <span className="capitalize">{scoreData.design.template}</span>
                      </span>
                      {scoreData.design.font && (
                        <span className="inline-flex items-center gap-1.5 text-xs font-medium bg-white/80 text-indigo-700 px-2.5 py-1 rounded-lg">
                          Font: <span className="capitalize">{scoreData.design.font.replace(/-/g, ' ')}</span>
                        </span>
                      )}
                      {scoreData.design.buttonShape && (
                        <span className="inline-flex items-center gap-1.5 text-xs font-medium bg-white/80 text-indigo-700 px-2.5 py-1 rounded-lg">
                          Buttons: <span className="capitalize">{scoreData.design.buttonShape}</span>
                        </span>
                      )}
                      {scoreData.design.bgValue && (
                        <span className="inline-flex items-center text-xs font-medium bg-white/80 text-indigo-700 px-2.5 py-1 rounded-lg gap-1.5">
                          <span className="w-3 h-3 rounded-full border border-indigo-200 shrink-0" style={{ background: scoreData.design.bgValue }} />
                          Custom palette
                        </span>
                      )}
                    </div>
